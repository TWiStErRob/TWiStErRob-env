...
@file:DependsOn("com.fasterxml.jackson.core:jackson-databind:2.22.2")
@file:DependsOn("com.fasterxml.jackson.module:jackson-module-kotlin:2.22.2")
@file:DependsOn("com.fasterxml.jackson.dataformat:jackson-dataformat-yaml:2.22.2")
