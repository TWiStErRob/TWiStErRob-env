...
@file:DependsOn("io.ktor:ktor-client-java-jvm:3.4.3")
@file:DependsOn("io.ktor:ktor-client-content-negotiation-jvm:3.4.3")
@file:DependsOn("io.ktor:ktor-client-logging-jvm:3.4.3")
@file:DependsOn("io.ktor:ktor-client-auth-jvm:3.4.3")
@file:DependsOn("io.ktor:ktor-serialization-jackson-jvm:3.4.3")
