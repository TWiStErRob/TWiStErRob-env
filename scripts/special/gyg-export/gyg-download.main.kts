#!/usr/bin/env kotlin
@file:DependsOn("com.fasterxml.jackson.core:jackson-databind:2.21.4")
@file:DependsOn("com.fasterxml.jackson.module:jackson-module-kotlin:2.21.4")
@file:DependsOn("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.21.4")
