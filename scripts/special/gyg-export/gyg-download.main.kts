#!/usr/bin/env kotlin
@file:DependsOn("com.fasterxml.jackson.core:jackson-databind:2.22.0")
@file:DependsOn("com.fasterxml.jackson.module:jackson-module-kotlin:2.22.0")
@file:DependsOn("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.22.0")
@file:DependsOn("com.github.ajalt.clikt:clikt-jvm:5.1.0")
@file:DependsOn("io.ktor:ktor-client-core-jvm:3.5.0")
@file:DependsOn("io.ktor:ktor-client-cio-jvm:3.5.0")
