...
@file:DependsOn("com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.21.2")
@file:DependsOn("com.github.ajalt.clikt:clikt-jvm:5.1.0")
@file:DependsOn("io.ktor:ktor-client-core-jvm:3.4.1")
@file:DependsOn("io.ktor:ktor-client-cio-jvm:3.4.1")
